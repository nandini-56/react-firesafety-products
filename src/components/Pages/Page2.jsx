...
const Page2 = () => {
    return (
        ...
        >
          ...
          <div className="pages">
      <ul className='pages-page-2'>
        <li>
        <Link to="/" style={{ textDecoration: 'none', listStyle: 'none', color:'black' }}>&lt;</Link>
        </li>
        <li >
          <Link to="/" style={{ textDecoration: 'none', listStyle: 'none', color:'black' }}> 1</Link>
        </li>
        <li style={{backgroundColor:'black'}}>
          <Link to="/page2" style={{ textDecoration: 'none', listStyle: 'none', color:'white' }}> 2</Link>
        </li>
        <li>
          <Link to="/page3" style={{ textDecoration: 'none', listStyle: 'none', color:'black' }}> 3</Link>
        </li>
        <li>
